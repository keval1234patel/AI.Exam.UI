...
import { ExamsDetailsDto, ExamsSubjectsQuestionsData, NewExamRequestsDto, Question, StartExamRequest, StudentExam, StudentExamSubjectsQandAData, SubmitExamRequest, SubjectsDetailsDto, SubjectData } from '../models/exam';
...
export class ExamService {
  ...
  GetStudentsDetailsBySubjectIdForTeacher(examId: string, subjectId: string): Observable<GeneralResponse<SubjectData>> {
    return this.http.get<GeneralResponse<SubjectData>>(
      `${this.baseUrl}/GetStudentsDetailsBySubjectIdForTeacher/${examId}/${subjectId}`
    );
  }
}
